...
#' @param data - A data matrix, where rows are metabolites and columns are sample IDs.
#' @param class.labels - A vector of binary indicators, where 1 is phenotype1 and 0 is phenotype2.
